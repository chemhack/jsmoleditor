package com.chemhack.jsMolEditor.client.jre.emulation.java.util.regex;
...
public class Pattern {
  ...
  private native void _match(String text, List matches)/*-{
   var regExp = this.@com.chemhack.jsMolEditor.client.jre.emulation.java.util.regex.Pattern::regExp;
